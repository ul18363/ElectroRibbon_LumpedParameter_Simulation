...
model.component('comp1').selection('sel19').set([exterior_oil_domain]);
...
model.component('comp1').selection('sel20').set([exterior_oil_domain]);
...
model.component('comp1').selection('sel22').set([nBoundaries-1 nBoundaries-3]);
...
model.component('comp1').selection.create('bottom_exposed_insulator_all_pre', 'Union');
model.component('comp1').selection('bottom_exposed_insulator_all_pre').set('entitydim', 1);
model.component('comp1').selection('bottom_exposed_insulator_all_pre').label('bottom_exposed_insulator_all_pre');
model.component('comp1').selection('bottom_exposed_insulator_all_pre').set('input', {'bottom_noise_surfaces' 'insulators_touch_points' 'bottom_insulator_exposed_to_oil'});

model.component('comp1').selection.create('bottom_exposed_insulator_all', 'Difference');
model.component('comp1').selection('bottom_exposed_insulator_all').set('entitydim', 1);
model.component('comp1').selection('bottom_exposed_insulator_all').label('bottom_exposed_insulator_all');
model.component('comp1').selection('bottom_exposed_insulator_all').set('add', {'bottom_exposed_insulator_all_pre'});
model.component('comp1').selection('bottom_exposed_insulator_all').set('subtract', {'left_edges' 'right_edges'});
...
model.component('comp1').selection.create('top_exposed_insulator_all_pre', 'Union');
model.component('comp1').selection('top_exposed_insulator_all_pre').set('entitydim', 1);
model.component('comp1').selection('top_exposed_insulator_all_pre').label('top_exposed_insulator_all_pre');
model.component('comp1').selection('top_exposed_insulator_all_pre').set('input', {'insulators_touch_points' 'top_noise_surfaces' 'top_insulator_exposed_to_oil'});


model.component('comp1').selection.create('top_exposed_insulator_all', 'Difference');
model.component('comp1').selection('top_exposed_insulator_all').set('entitydim', 1);
model.component('comp1').selection('top_exposed_insulator_all').label('top_exposed_insulator_all');
model.component('comp1').selection('top_exposed_insulator_all').set('add', {'top_exposed_insulator_all_pre'});
model.component('comp1').selection('top_exposed_insulator_all').set('subtract', {'left_edges' 'right_edges'});
...
model.nodeGroup('grp6').add('selection', 'bottom_exposed_insulator_all_pre');
...
model.nodeGroup('grp6').add('selection', 'top_exposed_insulator_all_pre');
