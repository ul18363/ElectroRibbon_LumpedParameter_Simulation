...
plot(obj.mechanical_model.top_plate.p(1,:),obj.mechanical_model.top_plate.p(2,:),'g-s')
...
displacement=0;
% 
% plot(com_mech.real_p_tp(1,:)-ref_init_x+displacement,com_mech.real_p_tp(2,:)-ref_init_y+ref_final_y,'g--')
% plot(com_mech.real_p_tp(1,:)-ref_init_x+displacement,-com_mech.real_p_tp(2,:)-ref_init_y+ref_final_y,'g--')
plot(com_mech.real_p_tp(1,:)-ref_init_x+displacement,initial_y+com_mech.real_p_tp(2,:),'r:')
