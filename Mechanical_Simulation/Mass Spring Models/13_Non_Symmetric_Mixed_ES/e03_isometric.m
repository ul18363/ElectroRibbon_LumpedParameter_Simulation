...
folder_name='e03_preprocessing_Stage_2_data';
extension='.mat';
...
%     voltage_ranges=[1,2,3,4,5,6]*1000;
    voltage_ranges=[1,3,5]*1000/2;
    %%
    %      voltage_ranges=[4,5,6]*1000;
%     if isequal(filename,'e03_preprocessing_Stage_2_data/e03_ready_to_turn_on_N_001_061mm.mat')
%         continue
%     end
    for voltage_ins=voltage_ranges
        %%
        % voltage_ins=0;
        %
        %         filename='e03_preprocessing_Stage_2_data/e03_ready_to_turn_on_N_001_061mm.mat';
        
        %         load(filename,'obj2','mm')
        %         voltage_ins=voltage_ranges(voltage_ins);
        %        voltage_ins=2000;
        ...
        while T<5
            ...
            if obj.mechanical_model.contact_ix>last_contact
                last_contact=obj.mechanical_model.contact_ix;
        ...
        % end
        output_folder='e03_data/';
        format='%05.f';
        output_file=[output_folder,'e03_N_',num2str(obj.N,format),'_',num2str(mm,format),'mm','_',num2str(voltage_ins,format),'KV'];
        %         obj2=obj;
        save(output_file,'obj','mm','voltage_ins')
    end
end