...
%     N=130;
    ...
    if N==21
        ...
        load(['e04_calibration/','resting_condition_N021_COMSOL_Validated_M008.mat'])
    ...
    elseif N==61
        damp_factor=100;%1-0.01s
        load(['e04_calibration/','resting_condition_N061_COMSOL_Validated_M008.mat'])
        obj.mechanical_model.top_plate.p=obj2.mechanical_model.top_plate.p;
        obj.mechanical_model.bottom_plate.p=obj2.mechanical_model.bottom_plate.p;
        shear_coeff=obj2.mechanical_model.bottom_plate.k_trans;
%         obj.mechanical_model.set_damping_factor(1);
    ...
    elseif N==130
        ...
        load(['e04_calibration/','resting_condition_N130_COMSOL_Validated_M008.mat'])
        obj.mechanical_model.top_plate.p=obj2.mechanical_model.top_plate.p;
        obj.mechanical_model.bottom_plate.p=obj2.mechanical_model.bottom_plate.p;
        shear_coeff=obj2.mechanical_model.bottom_plate.k_trans;
        obj.mechanical_model.set_damping_factor(damp_factor);
    ...
    results_file=['e04_results_',simulation_identifier,'.mat'];
