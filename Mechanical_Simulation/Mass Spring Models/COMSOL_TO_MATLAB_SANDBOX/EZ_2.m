...
% EZ_2.m
%
% Model exported on Aug 12 2020, 02:58 by COMSOL 5.5.0.359.
...
model.result.evaluationGroup('eg1').create('int5', 'IntLine');
model.result.evaluationGroup('eg1').create('int6', 'IntLine');
...
model.component('comp1').geom('geom1').feature('pol2').set('table', [-0.01 0; 0 0; 4.47921E-8 1.82E-14; 8.95841E-8 7.28E-14; 1.34376E-7 1.64E-13; 1.79168E-7 2.91E-13; 2.2396E-7 4.55E-13; 2.68752E-7 6.55E-13; 3.13544E-7 8.91E-13; 3.58337E-7 1.16E-12; 4.03129E-7 1.47E-12; 4.47921E-7 1.82E-12; 8.95841E-7 7.28E-12; 1.34376E-6 1.64E-11; 1.79168E-6 2.91E-11; 2.2396E-6 4.55E-11; 2.68752E-6 6.55E-11; 3.13544E-6 8.91E-11; 3.58336E-6 1.16E-10; 4.03128E-6 1.47E-10; 4.4792E-6 1.82E-10; 8.95837E-6 7.28E-10; 1.34375E-5 1.64E-9; 1.79167E-5 2.91E-9; 2.23958E-5 4.55E-9; 2.68749E-5 6.55E-9; 3.13539E-5 8.91E-9; 3.5833E-5 1.16E-8; 4.0312E-5 1.47E-8; 4.4791E-5 1.82E-8; 8.95798E-5 7.27E-8; 1.34367E-4 1.63E-7; 1.79151E-4 2.9E-7; 2.23933E-4 4.53E-7; 2.68714E-4 6.52E-7; 3.13492E-4 8.87E-7; 3.58268E-4 1.16E-6; 4.03042E-4 1.46E-6; 4.47814E-4 1.81E-6; 8.95416E-4 7.18E-6; 0.001342811 1.6E-5; 0.001790003 2.83E-5; 0.002236997 4.4E-5; 0.002683796 6.29E-5; 0.003130406 8.5E-5; 0.00357683 1.1E-4; 0.004023072 1.39E-4; 0.004469138 1.7E-4; 0.008921007 6.31E-4; 0.013359912 0.00131; 0.017790158 0.00214; 0.02221605 0.00304; 0.026641894 0.00394; 0.031071995 0.00477; 0.035510657 0.00546; 0.039962186 0.00593; 0.044430887 0.006115478; 0.049430887 0.006115478]);
model.component('comp1').geom('geom1').create('copy3', 'Copy');
model.component('comp1').geom('geom1').feature('copy3').set('disply', '-130E-6');
...
model.component('comp1').geom('geom1').feature('copy5').set('disply', '-(100E-6)-(1.3E-4)');
...
model.component('comp1').geom('geom1').feature('copy6').set('disply', '130E-6');
...
model.component('comp1').geom('geom1').feature('copy7').set('disply', '(100E-6)+(1.3E-4)');
model.component('comp1').geom('geom1').feature('copy7').selection('input').set({'pol2'});
model.component('comp1').geom('geom1').create('ls1', 'LineSegment');
model.component('comp1').geom('geom1').feature('ls1').selection('vertex1').set('copy7(1)', 1);
model.component('comp1').geom('geom1').feature('ls1').selection('vertex2').set('copy5(1)', 1);
...
model.component('comp1').selection('surrounding').set([1 6 7 8]);
...
model.component('comp1').selection('surrounding_surfaces').set([1 6 7 8]);
...
model.component('comp1').selection('right_edges').set([572 573 574 575]);
...
model.component('comp1').selection('right_edge_horiz').set('input', {'right_edges'});
...
model.component('comp1').mesh('mesh1').feature('ftri1').selection.named('insulator');
model.component('comp1').mesh('mesh1').feature('ftri1').create('size1', 'Size');
model.component('comp1').mesh('mesh1').feature('ftri2').selection.geom('geom1', 2);
model.component('comp1').mesh('mesh1').feature('ftri2').selection.set([7]);

model.component('comp1').view('view1').axis.set('xmin', -0.06922529637813568);
model.component('comp1').view('view1').axis.set('xmax', 0.10347682237625122);
model.component('comp1').view('view1').axis.set('ymin', -0.03281623125076294);
model.component('comp1').view('view1').axis.set('ymax', 0.029170900583267212);
...
model.result.evaluationGroup('eg1').feature('int1').set('expr', {'es.Py*es.Ey-if(x<0, es.Py*es.Ey, 0)*2' ''});
model.result.evaluationGroup('eg1').feature('int1').set('unit', {'N' ''});
model.result.evaluationGroup('eg1').feature('int1').set('descr', {'Diel_F' ''});
model.result.evaluationGroup('eg1').feature('int1').selection.named('bottom_insulator_domain');
model.result.evaluationGroup('eg1').feature('int2').set('expr', {'es.Ey^2*epsilon0_const*es.d'});
model.result.evaluationGroup('eg1').feature('int2').set('unit', {'N'});
model.result.evaluationGroup('eg1').feature('int2').set('descr', {'bottom_interface_force'});
model.result.evaluationGroup('eg1').feature('int2').selection.named('bottom_interface');
model.result.evaluationGroup('eg1').feature('int3').set('expr', {'es.Py*es.Ey-if(x<0, es.Py*es.Ey, 0)*2' ''});
model.result.evaluationGroup('eg1').feature('int3').set('unit', {'N' ''});
model.result.evaluationGroup('eg1').feature('int3').set('descr', {'Diel_F' ''});
model.result.evaluationGroup('eg1').feature('int3').selection.named('top_insulator_domain');
model.result.evaluationGroup('eg1').feature('int4').set('expr', {'es.Ey^2*epsilon0_const*es.d'});
model.result.evaluationGroup('eg1').feature('int4').set('unit', {'N'});
model.result.evaluationGroup('eg1').feature('int4').set('descr', {'top_interface_force'});
model.result.evaluationGroup('eg1').feature('int4').selection.named('bottom_interface1');
model.result.evaluationGroup('eg1').feature('int5').set('expr', {'es.nD*es.d'});
model.result.evaluationGroup('eg1').feature('int5').set('unit', {'C'});
model.result.evaluationGroup('eg1').feature('int5').set('descr', {'top_interface_charge'});
model.result.evaluationGroup('eg1').feature('int5').selection.named('top_interface_all');
model.result.evaluationGroup('eg1').feature('int6').set('expr', {'es.nD*es.d'});
model.result.evaluationGroup('eg1').feature('int6').set('unit', {'C'});
model.result.evaluationGroup('eg1').feature('int6').set('descr', {'bottom_interface_charge'});
model.result.evaluationGroup('eg1').feature('int6').selection.named('bottom_interface_all');
