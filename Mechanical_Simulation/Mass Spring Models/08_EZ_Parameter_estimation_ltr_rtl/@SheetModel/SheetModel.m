classdef SheetModel < handle % "< handle"  allow you to pass the instance as reference
    ...
    methods
        ...
        function generate_discrete_model(obj)
            ...
            obj.axial_force_local_direction='particle to particle'; % Direct forces are in the direction connecting the particles.
            obj.shear_coefficient_source='edges'; % If the shear coefficient comes from the "edges" it will have length N-1, if it comes from "particles" it will have length N
                % Options can be ->'relative x direction'/'particle to particle'
            %% Define discrete elements
            ...
            %% Define variables that need to be initialized beforehand
