function varargout = layout_empty_export(varargin)
% LAYOUT_EMPTY_EXPORT MATLAB code for layout_empty_export.fig
%      LAYOUT_EMPTY_EXPORT, by itself, creates a new LAYOUT_EMPTY_EXPORT or raises the existing
%      singleton*.
%
%      H = LAYOUT_EMPTY_EXPORT returns the handle to a new LAYOUT_EMPTY_EXPORT or the handle to
%      the existing singleton*.
%
%      LAYOUT_EMPTY_EXPORT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in LAYOUT_EMPTY_EXPORT.M with the given input arguments.
%
%      LAYOUT_EMPTY_EXPORT('Property','Value',...) creates a new LAYOUT_EMPTY_EXPORT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before layout_empty_export_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to layout_empty_export_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help layout_empty_export

% Last Modified by GUIDE v2.5 26-Jun-2020 22:26:37

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @layout_empty_export_OpeningFcn, ...
                   'gui_OutputFcn',  @layout_empty_export_OutputFcn, ...
                   'gui_LayoutFcn',  @layout_empty_export_LayoutFcn, ...
                   'gui_Callback',   []);
...
% --- Executes just before layout_empty_export is made visible.
function layout_empty_export_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to layout_empty_export (see VARARGIN)

% Choose default command line output for layout_empty_export
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes layout_empty_export wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = layout_empty_export_OutputFcn(hObject, eventdata, handles) 
...
function h1 = layout_empty_export_LayoutFcn(policy)
...
appdata.GUIDEOptions = struct(...
    ...
    'syscolorfig', 1, ...
    'blocking', 0, ...
    'lastSavedFile', '/home/bruno/Repositories/Personal/MATLAB_Dissertation/Mechanical_Simulation/Mass Spring Models/09_MATLAB_GUI/layout_empty_export.m', ...
    'lastFilename', '/home/bruno/Repositories/Personal/MATLAB_Dissertation/Mechanical_Simulation/Mass Spring Models/09_MATLAB_GUI/layout_empty.fig');
...
'PaperUnits','inches',...
'Units','characters',...
'Position',[135.8 33.8846153846154 177.142857142857 50.5],...
...
'PlotBoxAspectRatio',[1 0.903005464480874 0.903005464480874],...
...
'Position',[68.4285714285714 8 104.571428571429 41.3125],...
'InnerPosition',[68.4285714285714 8 104.571428571429 41.3125],...
...
'LooseInset',[23.0285714285714 5.555 16.8285714285714 3.7875],...
...
'Color',[0 0 0],...
'ColorMode','auto',...
'Position',[0.500001102197366 1.00416036308623 0.500000000000007],...
'PositionMode','auto',...
'Interpreter','tex',...
...
'ColorMode','auto',...
'Position',[0.500000476837158 -0.0358043360968641 7.105427357601e-15],...
'PositionMode','auto',...
'Interpreter','tex',...
'InterpreterMode','auto',...
'Rotation',0,...
...
'Color',[0.15 0.15 0.15],...
'ColorMode','auto',...
'Position',[-0.042805099286451 0.500000476837158 7.105427357601e-15],...
'PositionMode','auto',...
'Interpreter','tex',...
'InterpreterMode','auto',...
'Rotation',90,...
...
'Position',[17 4.75 21.5714285714286 1.9375],...
'Callback',@(hObject,eventdata)layout_empty_export('pushbutton1_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tag','pushbutton1',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'String',{  'Slider' },...
'Style','slider',...
'Position',[17.5714285714286 7.8125 3.71428571428572 37.75],...
'BackgroundColor',[0.9 0.9 0.9],...
'Callback',@(hObject,eventdata)layout_empty_export('slider1_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ButtonDownFcn',@(hObject,eventdata)layout_empty_export('slider1_ButtonDownFcn',hObject,eventdata,guidata(hObject)),...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)layout_empty_export('slider1_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','slider1');
...
'String',{  'Slider' },...
'Style','slider',...
'Position',[22.7142857142857 7.8125 3.71428571428572 37.75],...
'BackgroundColor',[0.9 0.9 0.9],...
'Callback',@(hObject,eventdata)layout_empty_export('slider2_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Visible',get(0,'defaultuicontrolVisible'),...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)layout_empty_export('slider2_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'Tag','slider2',...
...
'Units','characters',...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'String','Start/Pause Simulation',...
'Style','togglebutton',...
'Position',[132.571428571429 2.5625 34.1428571428571 4.125],...
'Callback',@(hObject,eventdata)layout_empty_export('pushbutton2_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'Tag','pushbutton2');
...
'String','10^-7',...
'Style','edit',...
'Position',[111.285714285714 5 15.1428571428571 1.6875],...
'Callback',@(hObject,eventdata)layout_empty_export('edit2_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)layout_empty_export('edit2_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','edit2');
...
'Position',[5.14285714285714 7.9375 9 1.875],...
'BackgroundColor',get(0,'defaultuicontrolBackgroundColor'),...
'Callback',@(hObject,eventdata)layout_empty_export('edit1_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tooltip',blanks(0),...
...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)layout_empty_export('edit1_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'Tag','edit1',...
'UserData',[],...
'KeyPressFcn',blanks(0),...
...
'String',{  'Slider' },...
'Style','slider',...
'Position',[45 7.6875 3.71428571428572 37.75],...
'BackgroundColor',[0.9 0.9 0.9],...
'Callback',@(hObject,eventdata)layout_empty_export('slider3_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)layout_empty_export('slider3_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'Tag','slider3',...
'KeyPressFcn',blanks(0));
...
'String',{  'Slider' },...
'Style','slider',...
'Position',[50.1428571428571 7.6875 3.71428571428572 37.75],...
'BackgroundColor',[0.9 0.9 0.9],...
'Callback',@(hObject,eventdata)layout_empty_export('slider4_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Visible',get(0,'defaultuicontrolVisible'),...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)layout_empty_export('slider4_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'Tag','slider4',...
'KeyPressFcn',blanks(0));
...
'String','Direct',...
'Style','text',...
'Position',[16.5714285714286 48.375 11.8571428571429 1.1875],...
'Children',[],...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'Tag','text2');
...
'String','Shear',...
'Style','text',...
'Position',[42.7142857142857 48.3125 11.8571428571429 1.1875],...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'String','10^(2)',...
'Style','text',...
'Position',[3.57142857142857 4.75 10.7142857142857 1.9375],...
'Children',[],...
'Visible',get(0,'defaultuicontrolVisible'),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'Tag','text4');
...
'Style','edit',...
'Value',get(0,'defaultuicontrolValue'),...
'Position',[7 44.1875 9 1.875],...
'BackgroundColor',get(0,'defaultuicontrolBackgroundColor'),...
'Callback',@(hObject,eventdata)layout_empty_export('edit3_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tooltip',blanks(0),...
'ForegroundColor',get(0,'defaultuicontrolForegroundColor'),...
'Enable',get(0,'defaultuicontrolEnable'),...
...
'HandleVisibility',get(0,'defaultuicontrolHandleVisibility'),...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)layout_empty_export('edit3_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'Tag','edit3',...
'UserData',[],...
'KeyPressFcn',blanks(0),...
...
'String','0',...
'Style','text',...
'Position',[27.4285714285714 44.9375 3.14285714285714 1.25],...
'Children',[],...
'Visible','off',...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
'String','1',...
'Style','text',...
'Position',[26.5714285714286 7 3.14285714285714 1.375],...
'Children',[],...
'Visible','off',...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
'Style','edit',...
'Value',get(0,'defaultuicontrolValue'),...
'Position',[33.7142857142857 44.1875 9 1.875],...
'BackgroundColor',get(0,'defaultuicontrolBackgroundColor'),...
'Callback',@(hObject,eventdata)layout_empty_export('edit4_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tooltip',blanks(0),...
'ForegroundColor',get(0,'defaultuicontrolForegroundColor'),...
'Enable',get(0,'defaultuicontrolEnable'),...
...
'HandleVisibility',get(0,'defaultuicontrolHandleVisibility'),...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)layout_empty_export('edit4_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'Tag','edit4',...
'UserData',[],...
'KeyPressFcn',blanks(0),...
...
'Style','edit',...
'Value',get(0,'defaultuicontrolValue'),...
'Position',[35.5714285714286 7.9375 9 1.875],...
'BackgroundColor',get(0,'defaultuicontrolBackgroundColor'),...
'Callback',@(hObject,eventdata)layout_empty_export('edit5_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tooltip',blanks(0),...
'ForegroundColor',get(0,'defaultuicontrolForegroundColor'),...
'Enable',get(0,'defaultuicontrolEnable'),...
...
'HandleVisibility',get(0,'defaultuicontrolHandleVisibility'),...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)layout_empty_export('edit5_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'Tag','edit5',...
'UserData',[],...
'KeyPressFcn',blanks(0),...
...
'String','0',...
'Style','text',...
'Position',[55.1428571428571 45.375 3.14285714285715 1.25],...
'Children',[],...
'Visible','off',...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
'String','1',...
'Style','text',...
'Position',[54.2857142857143 7.4375 3.14285714285715 1.375],...
'Children',[],...
'Visible','off',...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
'String','10^-2',...
'Style','edit',...
'Position',[111.285714285714 2.5625 15.1428571428571 1.6875],...
'Callback',@(hObject,eventdata)layout_empty_export('edit6_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)layout_empty_export('edit6_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'Tag','edit6',...
'KeyPressFcn',blanks(0));
...
'String','Refresh T:',...
'Style','text',...
'Position',[99.8571428571428 2.8125 9.85714285714286 1.375],...
'Children',[],...
'Visible','off',...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
'String','TimeStep:',...
'Style','text',...
'Position',[98.7142857142857 5.3125 12.1428571428571 1.0625],...
'Children',[],...
'Visible','off',...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
'String','10^(2)',...
'Style','text',...
'Position',[42.7142857142857 4.75 10.7142857142857 1.9375],...
'Children',[],...
'Visible',get(0,'defaultuicontrolVisible'),...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
'String','Reset',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[55.7142857142857 1.25 17.2857142857143 2.3125],...
'Callback',@(hObject,eventdata)layout_empty_export('pushbutton3_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
elseif local_isInvokeHGCallback(gui_State, varargin{:})
    % LAYOUT_EMPTY_EXPORT('CALLBACK',hObject,eventData,handles,...)
    gui_Create = false;
else
    % LAYOUT_EMPTY_EXPORT(...)
