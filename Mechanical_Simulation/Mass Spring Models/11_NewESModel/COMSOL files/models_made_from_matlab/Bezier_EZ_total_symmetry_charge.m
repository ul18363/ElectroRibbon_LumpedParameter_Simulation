function out = model
%
% Bezier_EZ_total_symmetry_charge.m
%
% Model exported on Jun 30 2020, 23:11 by COMSOL 5.5.0.359.
...
model.modelPath('/home/bruno/Repositories/Personal/MATLAB_Dissertation/Mechanical_Simulation/Mass Spring Models/10_MATLAB_Electromechanics_full_symmetry/COMSOL files/models_for_matlab');

model.label('Bezier_EZ_total_symmetry_charge.mph');
...
model.component('comp1').geom('geom1').feature('del1').selection('input').set('r2(1)', 2);
model.component('comp1').geom('geom1').feature('del1').selection('input').set('r3(1)', 4);
model.component('comp1').geom('geom1').create('csol1', 'ConvertToSolid');
model.component('comp1').geom('geom1').feature('csol1').selection('input').set({'cb1' 'cb2' 'del1'});
...
model.component('comp1').physics('esbe').feature('ccn1').selection('symsel1').set([4 6]);
...
model.result.table('tbl1').comments('Global Evaluation');

model.component('comp1').view('view1').axis.set('xmin', -0.012829996645450592);
model.component('comp1').view('view1').axis.set('xmax', 0.0494299978017807);
model.component('comp1').view('view1').axis.set('ymin', -0.02847800962626934);
model.component('comp1').view('view1').axis.set('ymax', 0.012378009036183357);
...
model.result.numerical.create('num1', 'IntSurface');
model.result.numerical.create('num2', 'IntSurface');
model.result.numerical.create('num3', 'IntSurface');
model.result.numerical.create('num4', 'IntSurface');
model.result.numerical.create('custom1', 'Eval');
model.result.numerical.create('q', 'EvalGlobal');
model.result.numerical.create('q2', 'Global');
model.result.numerical.create('qint', 'IntLine');
model.result.numerical('num1').set('probetag', 'none');
model.result.numerical('num2').set('probetag', 'none');
model.result.numerical('num3').set('probetag', 'none');
model.result.numerical('num4').set('probetag', 'none');
model.result.numerical('q').set('probetag', 'none');
model.result.numerical('qint').set('probetag', 'none');
...
model.result('pg5').feature('lngr3').selection.set([5 8]);
model.result('pg5').feature('lngr3').set('expr', 'x');
model.result('pg5').feature('lngr1').selection.set([5 8]);
model.result('pg5').feature('lngr1').set('expr', 'esbe.unTx');
model.result('pg5').feature('lngr2').selection.set([5 8]);
model.result('pg5').feature('lngr2').set('expr', 'esbe.unTy');
model.result('pg5').feature('lngr4').selection.set([5 8]);
model.result('pg5').feature('lngr4').set('expr', 'y');
model.result('pg5').feature('lngr5').set('xdata', 'reversedarc');
model.result('pg5').feature('lngr5').selection.set([8]);
...
model.result.numerical('num1').set('intorderactive', true);
model.result.numerical('num2').set('intorderactive', true);
model.result.numerical('num3').set('expr', {'x'});
model.result.numerical('num3').set('unit', {'m^3'});
model.result.numerical('num3').set('descr', {'x-coordinate'});
model.result.numerical('num3').set('intorderactive', true);
model.result.numerical('num4').set('expr', {'x'});
model.result.numerical('num4').set('unit', {'m^3'});
model.result.numerical('num4').set('descr', {'x-coordinate'});
model.result.numerical('num4').set('intorderactive', true);
model.result.numerical('custom1').set('expr', {'esbe.Q0_1'});
model.result.numerical('custom1').set('unit', {'C'});
model.result.numerical('custom1').set('descr', {'x-coordinate' 'y-coordinate'});
model.result.numerical('q').set('table', 'tbl1');
model.result.numerical('q').set('expr', {'esbe.Q0_1'});
model.result.numerical('q').set('unit', {'C'});
model.result.numerical('q').set('descr', {'Terminal charge'});
model.result.numerical('q2').set('expr', {'esbe.Q0_1'});
model.result.numerical('q2').set('unit', {'C'});
model.result.numerical('q2').set('descr', {'Terminal charge'});
model.result.evaluationGroup('eg1').set('data', 'dset1');
model.result.evaluationGroup('eg1').feature('int2').set('expr', {'esbe.nD*esbe.d'});
model.result.evaluationGroup('eg1').feature('int2').set('unit', {'C'});
model.result.evaluationGroup('eg1').feature('int2').set('descr', {''});
model.result.evaluationGroup('eg1').feature('int2').selection.set([1 2 3 5 7 8]);
